class Carousel {
  ...
  _initConfig(paramObject) {
    ...
    if (typeof paramObject !== 'undefined') {
      defaultSettings.containerID = paramObject.containerID || defaultSettings.containerID;
      defaultSettings.slideID = paramObject.slideID || defaultSettings.slideID;
      defaultSettings.interval = paramObject.interval || defaultSettings.interval;
      defaultSettings.isPlaying = paramObject.isPlaying || defaultSettings.isPlaying;
    }
